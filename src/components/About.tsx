  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        ...
        <p className="mb-6">
          Hi, I'm Emmanuel Mitchell, a passionate Frontend Web Developer and
          UI/UX Designer. With a strong foundation in web development, I
          specialize in building dynamic, responsive, and user-friendly
          applications. I have advanced expertise in UI design principles,
          ensuring that every project is not only functional but also visually
          engaging. I enjoy combining technical skills with creative
          problem-solving to deliver high-quality digital experiences.
        </p>
